...
AdaptiveRenderStrategy::AdaptiveRenderStrategy(
	const AdaptiveRenderStrategy &other) : RenderDistanceStrategy()
{
	(void)other;
}
...
int32_t AdaptiveRenderStrategy::clamp_int(int32_t value, int32_t minimum,
	int32_t maximum)
{
	if (value < minimum)
		return (minimum);
...
int32_t AdaptiveRenderStrategy::update_render_distance(int32_t current_distance,
	double frame_ms, bool boost_enabled) const
{
