...
RenderCache::RenderCache() : yaw_cos(1.0), yaw_sin(0.0), pitch_cos(1.0),
	pitch_sin(0.0), fov_tangent(1.0), aspect_ratio(1.0), focal_length(1.0),
	half_width(0.0), half_height(0.0), render_distance(0.0)
{
}

RenderCache::RenderCache(const RenderCache &other) : yaw_cos(1.0), yaw_sin(0.0),
	pitch_cos(1.0), pitch_sin(0.0), fov_tangent(1.0), aspect_ratio(1.0),
	focal_length(1.0), half_width(0.0), half_height(0.0), render_distance(0.0)
{
	*this = other;
}
